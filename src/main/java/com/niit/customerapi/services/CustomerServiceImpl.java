...
public class CustomerServiceImpl implements CustomerService{
	...
	/*
	 * @Override public Customer updateCustomer(long accountNo, String newEmail) {
	 * Customer customer=findCustomer(accountNo); if(customer!=null){
	 * customer.setEmail(newEmail); return customerRepository.save(customer); }else
	 * { return null; } }
	 */
